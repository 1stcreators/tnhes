...
import providestaff from '../../assets/images/provide_staff.svg';
import featureprojects from '../../assets/images/feature_projects.png';
import servicehighlights from '../../assets/images/service_highlights.png';
      ...
      <div className="row">
        <div className="col-md-12 text-center"> 
             ...
             <p>TalentPro provides one of the most advanced and professional staffing solutions in India for temporary, regular staffing. 
               ...
               of staffing a pleasure. <br/><br/>
               
               With over 50,000 staff already deployed across various industries, TalentPro is working hard to increase 
               its presence across the country. With offices covering the whole of India, 
               we can offer the perfect staffing solutions for you with workers that are sourced locally and trained for your requirements.</p>
          </div>
          </div>
     </div>
   </section>
    ...
    <div className="row whiteBg">
      <div className="col-md-6"> 
        <ul>
          ...
          <li><span></span> Staffing and recruitment are challenging and cumbersome tasks to an organisation. Outsourcing your staffing needs to a contract staffing 
            agency reduces your tension and burden of finding suitable human resources.</li>
          <li><span></span> Outsourcing staffing solutions to TalentPro means that you are assured of a constant pipeline of talent required for your business or organisation.</li>
          <li><span></span> TalentPro is one of the top most staffing companies in India with over 50,000 people deployed across all industry sectors all over India.</li>
          <li><span></span> Irrespective of your location in India, TalentPro can provide manpower services by identifying, training and placing local resources and cater to your organisation.</li>
        </ul>
        </div>
        ...
        <div className="col-md-6"> 
          <ul>
            ...
            <li><span></span> We take over the risks that are usually associated with temporary staffing and contract staffing. This means that your risk and concerns levels are nil.</li>
            <li><span></span> TalentPro, one of the top temp staffing companies in India, can provide unlimited manpower at an affordable cost.</li>
            <li><span></span> Integrated offering, Recruitment - national team, linked to relationship teams, Greater accountability Uniform client updatesnap.</li>
            <li><span></span> Our constantly updated HRMS system ensures accurate and latest data at super speeds. You always have access to different types of reports in a snap.</li>
            <li></li>
          </ul>
          </div>
        </div>
        ...
        <div className="col-md-6">
         ...
         <p>The way we have structured our staffing solutions, all you have to do is to give us a green signal, and you will find your productivity increasing overnight.
            ...
            <ul className="p-0">
              ...
              <li><span></span> An error-free, highly secured, and flexible payroll management system that pays employees on time.</li>
              <li><span></span> An error-free, highly secured, and flexible payroll management system that pays employees on time.</li>
              <li><span></span> Powerful and proven computerized system that includes self-service portals, query management system, help desks, and MIS for your management.</li>
              <li><span></span> Complete compliance management that takes care of minimum wages, PF, ESIC, and labor laws. You are protected 100% all the time.</li>
              <li><span></span> Complete and proven associate management that keeps our staff who work for you happy.</li>
            </ul>
        </div>  
       </div>
             ...
             <p>TalentPro specializes in temporary staffing. Why should you think of temporary staffing solutions as an option for your business or organization? Read on, 
               ...
               Once their job or requirement is over, you inform us, and we will take care of their exit. It is as simple as that.</p>
                <ul className="p-0">
                  ...
                  <li><span></span> Do you need human resources for particular positions or in groups?</li>
                  <li><span></span> Talks to us and let TalentPro surprise you as to how temporary staffing can impact your business and finances directly.</li>
                </ul>
            </div>  
           </div>           
          </div>
